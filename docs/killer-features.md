# :fire: Killer Features — v1.5.0

FlowyML Notebook v1.5.0 introduces **13 new modules** that transform your notebook from a scratchpad into a professional data-science workstation. Every feature is available via Python API, CLI, and GUI — zero configuration required.

!!! success "What's New in v1.5.0"
